...
const FileUpload = ({ onFileSelect }: TFileUploadProps) => {
  ...
  return (
    <div
      ...
      className="flex flex-col justify-center items-center w-full py-6 border border-dashed border-primary"
    >
      <input
        type="file"
        className="hidden"
      ...
      {!file ? (
        ...
        <div className="text-center">
          ...
          <button
            onClick={removeFile}
            className="flex gap-2 bg-primary/90 text-white mx-auto rounded mt-4"
          >
